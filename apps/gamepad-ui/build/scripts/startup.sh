...
export LUTRIS_GAMEPAD_UI_DISABLE_AUDIO_SETTINGS=1
export LUTRIS_GAMEPAD_UI_DISABLE_DISPLAY_SETTINGS=1
export LUTRIS_GAMEPAD_UI_DISABLE_BLUETOOTH_SETTINGS=1
